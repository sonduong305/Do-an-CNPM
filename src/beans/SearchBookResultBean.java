...
public class SearchBookResultBean {
    ...
    private String authors = "Updating..";
    private String branchId= "Updating..";
    private String noOfCopies= "Updating..";
    ...
    public SearchBookResultBean(String bookId,String title) {
    	this.bookId = bookId;
        this.title = title;
    }
